...
@loader.tds
class YumakaChatMod(loader.Module):
    """Admin Tools"""

    strings = {
        "name": "Yumaka Chat",
        "not_pic": "❌ <b>Это не картинка/стикер.</b>",
        "wait": "🕑 <code>Ожидайте...</code>",
        "pic_so_small": "❌ <b>Картинка слишком маленькая, повторите позже.</b>",
        "pic_changed": "✅ <b>Фото чата успешно изменено.</b>",
        "promote_none": "🤷 <b>Кого повысить?</b>",
        "who": "🙎 <b>Что это?</b>",
        "not_admin": "🤷 <b>Я тут не админ или у меня нет прав администратора.</b>",
        "promoted": "👮 <b>{} назначен администратором.\nРанк: {}</b>",
        "wtf_is_it": "💀 <b>Что это?</b>",
        "this_isn`t_a_chat": "❌ <b>Это не чат гений!</b>",
        "demote_none": "🤷 <b>Кого понизить?</b>",
        "demoted": "🧑‍💼<b>{} разжалован от прав.</b>",
        "pinning": "<code>Закрепляю...</code>",
        "pin_none": "📌 <b>Реплай.</b>",
        "unpinning": "<code>Открепляю...</code>",
        "unpin_none": "📌 <b>Ничего открепить.</b>",
        "no_rights": "📌 <b>Я не имею прав закреплять сообщений.</b>",
        "pinned": "📌 <b>Закреплено успешно!</b>",
        "unpinned": "📌 <b>Откреплено успешно!</b>",
        "can`t_kick": "🚪 <b>Не могу кикать.</b>",
        "kicking": "🚪 <b>Кик...</b>",
        "kick_none": "🚪 <b>Кого кикать?</b>",
        "kicked": "🚪 <b>{} кикнут с чата.</b>",
        "kicked_for_reason": "🚪 <b>{} кикнут с чата.\nПричина: {}.</b>",
        "banning": "<code>Ban...</code>",
        "banned": "⛔ <b>{} забанен в чате.</b>",
        "banned_for_reason": "⛔ <b>{} забанен в чате.\nПричина: {}</b>",
        "ban_none": "⛔ <b>Кого забанить?</b>",
        "unban_none": "✅ <b>Кого разбанить?</b>",
        "unbanned": "✅ <b>{} разбанен в чате.</b>",
        "mute_none": "🤷 <b>Кого мутить?</b>",
        "muted": "🤐 <b>{} замучен в чате на </b>",
        "no_args": "⛔ <b>Неверные оргументы.</b>",
        "unmute_none": "⛔ <b>Кого размутить?</b>",
        "unmuted": "🤐 <b>{} замучен в чате.</b>",
        "no_reply": "<b>Нет реплая.</b>",
        "del_u_search": "📛 <code>Поиск удалённых аккаунтов...</code>",
        "del_u_kicking": "📛 <b>Кикнуты удалённые аккаунты.\nЯ могу это?!</b>",
    }
